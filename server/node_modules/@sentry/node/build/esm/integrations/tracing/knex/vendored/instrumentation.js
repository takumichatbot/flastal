...
import { SDK_VERSION, getActiveSpan, startSpan, SPAN_STATUS_ERROR, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN } from '@sentry/core';
import { InstrumentationNodeModuleFile } from '../../InstrumentationNodeModuleFile.js';
import { ATTR_DB_STATEMENT, ATTR_NET_TRANSPORT, ATTR_NET_PEER_PORT, ATTR_NET_PEER_NAME, ATTR_DB_USER, ATTR_DB_SYSTEM, ATTR_DB_NAME, ATTR_DB_OPERATION, ATTR_DB_SQL_TABLE } from './semconv.js';
    ...
    return function wrapQuery(original) {
      return function wrapped_logging_method(query) {
        ...
        const attributes = {
          ...
          [ATTR_NET_TRANSPORT]: config?.connection?.filename === ":memory:" ? "inproc" : void 0,
          [ATTR_DB_STATEMENT]: limitLength(query?.sql, MAX_QUERY_LENGTH)
        };
