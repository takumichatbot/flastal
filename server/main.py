...
@fastapi_app.put("/api/projects/{project_id}")
...
@fastapi_app.get("/api/venues", response_model=list[schemas.Venue])
...
@fastapi_app.post("/api/reports/project")
...
# 投票API
@fastapi_app.post("/api/group-chat/polls/vote")
