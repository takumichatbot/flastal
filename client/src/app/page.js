...
// ★修正: 不足していた User, CheckCircle2 を追加しました
import { 
  ...
  Smile, ShieldCheck, ThumbsUp, Camera, Music, Video, PenTool, User, MapPin, Store
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link href="/projects/create" className="w-full sm:w-auto">
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full bg-gradient-to-r from-pink-500 to-rose-500 text-white px-10 md:px-14 py-5 md:py-6 rounded-full text-lg md:text-2xl font-black shadow-xl flex items-center justify-center gap-3 mx-auto"
          >
