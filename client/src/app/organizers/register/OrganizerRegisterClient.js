    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center p-4">
        <div className="w-full max-w-lg p-8 bg-white rounded-2xl shadow-xl border border-indigo-100 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">申請を受け付けました</h2>
          ...
          <Link href="/" className="block w-full py-3.5 bg-indigo-600 text-white rounded-lg font-bold text-lg shadow-md hover:bg-indigo-700 transition-all">
            トップページへ戻る
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-indigo-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><FiBriefcase className="text-gray-400" /></div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type={showPassword ? 'text' : 'password'} {...register('password', { required: '必須です', minLength: { value: 6, message: '6文字以上' } })} placeholder="8文字以上" className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" />
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><FiGlobe className="text-gray-400" /></div>
        ...
        <div className="text-center mt-6 pt-6 border-t border-gray-100">
          <p className="text-sm text-gray-600">すでにアカウントをお持ちですか？ <Link href="/organizers/login" className="font-bold text-indigo-600 hover:underline">ログイン</Link></p>
        </div>
      </div>
    </div>
  );
