...
import { Save, Camera, ArrowLeft, User, Loader2, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-[2.5rem] shadow-xl p-8 md:p-12 border border-white">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link href="/organizers/dashboard" className="p-2 bg-slate-50 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded-full transition-all">
            <ArrowLeft size={24}/>
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-32 h-32 group">
              <div className="w-full h-full rounded-[2.5rem] overflow-hidden border-4 border-white shadow-2xl relative bg-slate-50 ring-4 ring-slate-200/50 transition-all group-hover:ring-slate-300/50">
                {previewIcon ? (
                  <Image 
                    src={previewIcon} 
                    alt="Organizer Icon" 
              ...
              <label className="absolute -bottom-2 -right-2 bg-slate-900 text-white p-3 rounded-2xl cursor-pointer hover:bg-slate-700 shadow-xl border-4 border-white transition-all active:scale-95">
                <Camera size={20}/>
                <input 
                  type="file" 
                  className="hidden" 
          ...
          <div className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full p-4 bg-slate-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-slate-400 outline-none transition-all font-bold text-slate-800" 
                placeholder="団体名を入力"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  {...register('website')} 
                  type="url" 
                  className="w-full pl-12 p-4 bg-slate-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-slate-400 outline-none transition-all text-sm" 
            ...
            <div>
              ...
              <textarea 
                {...register('bio')} 
                rows="4" 
                className="w-full p-4 bg-slate-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-slate-400 outline-none transition-all resize-none text-sm leading-relaxed text-slate-600" 
          ...
          <button 
            ...
            className="w-full py-5 bg-slate-900 text-white font-black rounded-[1.5rem] shadow-2xl hover:bg-slate-700 transition-all flex justify-center items-center gap-3 active:scale-95 disabled:opacity-50"
          >
